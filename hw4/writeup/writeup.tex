...
Figures below show the results obtained for the three images - Notre Dame, Mount Rushmore, and Episcopal Gaudi: 
\begin{figure}[h]
	\centering
	\begin{subfigure}{0.4\linewidth}
		\includegraphics[width=\linewidth]{../code/eval_ND.png}
		\caption{Notre Dame}
	\end{subfigure} \\
	% 
	\begin{subfigure}{0.4\linewidth}
		\includegraphics[width=\linewidth]{../code/eval_MR.png}
		\caption{Mount Rushmore}
	\end{subfigure}
	%
	\begin{subfigure}{0.4\linewidth}
		\includegraphics[width=\linewidth]{../code/eval_EG.png}
		\caption{Episcopal Gaudi}
	\end{subfigure}
	%
\end{figure}

\section*{match$\_$features.m}
